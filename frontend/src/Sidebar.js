...
import { FaHome, FaUser, FaUserPlus, FaFileInvoice, FaCalendarAlt, FaChartLine, FaSignOutAlt, FaTachometerAlt } from "react-icons/fa";
    ...
    <div className={SidebarCSS.sidebar}>
      <div className={SidebarCSS.leftSide}>
        ...
        <ul className={SidebarCSS.menu}>
          ...
          <li>
            <Link to="/admin-dashboard">  {/* New Dashboard link */}
              <FaTachometerAlt className={SidebarCSS.icon} /> Admin Dashboard
            </Link>
          </li>
