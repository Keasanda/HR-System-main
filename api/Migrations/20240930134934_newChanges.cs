    ...
    public partial class newChanges : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForgotPasswordModels", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResetPasswordModels", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "078d6e88-e883-4578-9a12-8282eb73b847", null, "Admin", "ADMIN" },
                    { "fd318d61-1278-4c25-b4a3-8eb89e0ed34f", null, "User", "USER" }
                });
