...
public async Task<IActionResult> CreateEmployee([FromBody] EmployeeDto employeeDto)
{
    ...
    var employee = new Employee
    {
       ...
       Email = EncryptionHelper.EncryptString(employeeDto.Email),
      IdentityNumber = EncryptionHelper.EncryptString(employeeDto.IdentityNumber),
         PassportNumber = EncryptionHelper.EncryptString(employeeDto.PassportNumber),
        DateOfBirth = employeeDto.DateOfBirth,
        Gender = employeeDto.Gender,
        TaxNumber =  EncryptionHelper.EncryptString(employeeDto.TaxNumber),
        ...
        Url = employeeDto.Url,
        PasswordHash =  EncryptionHelper.EncryptString (employeeDto.PasswordHash),
...
public async Task<IActionResult> GetEmployees()
{
    ...
    {   EmployeeId = e.EmployeeId,
        Name = e.Name,
        Surname = e.Surname,
          Email = EncryptionHelper.DecryptString(e.Email),
        IdentityNumber =  EncryptionHelper.DecryptString(e.IdentityNumber),
        PassportNumber =  EncryptionHelper.DecryptString(e.PassportNumber),
        DateOfBirth = e.DateOfBirth,
        Gender = e.Gender,
        TaxNumber = EncryptionHelper.DecryptString(e.TaxNumber),
